...
import { Box, Heading, Text, useColorMode, useColorModeValue, VStack } from '@chakra-ui/react'
// eslint-disable-next-line no-unused-vars
            ...
            >
              ...
              <Text 
                ...
                >
                  ...
                  <Text>B.T Shahani Navin Hind High School, Pune</Text>
                </Text>
                  </Box>
                  </motion.div>
...
{/* Second option  */}
      ...
      <Box bg={bg} color={color} p={10} m={10} rounded={25}>
        <h2 className="text-3xl font-bold text-center mb-8">Qualifications</h2>
