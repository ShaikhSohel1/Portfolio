  ...
  return isLargeScreen ? (
    <VStack w={"auto"} justifyContent={"space-evenly"} gap={20}>
      ...
      <HStack  gap={20} w={"auto"} mx={36} px={5} > 
        ...
        <Grid templateColumns='repeat(2, 1fr)' gap={"14"} bg={bg} color={color} p={5} gridArea={"auto"} boxSize={"auto"} rounded={20} templateAreas={`"header header"
    `}> 
...
{/* Backend  */}
<Grid templateColumns='repeat(2, 1fr)' gap={"14"} justifyContent={"center"} alignContent={"center"} bg={bg} color={color} p={5} gridArea={"auto"} boxSize={"auto"} rounded={20} templateAreas={`"header header"
    `}> 
        <GridItem  area={'header'} textAlign={"center"} >
...
<Box boxSize={"auto"}>
                ...
                <HStack>
                  ...
                  <Text noOfLines={1} fontWeight={"bold"} fontSize={"12"} overflow={"scroll"}>
                      HTML5
